...
// Color key type
export type ColorKey = 'emerald' | 'amber' | 'zinc' | 'sky' | 'violet' | 'blue'
...
// Grid color preset
export interface GridColorPreset {
  name: string
  value: string
}

// Layout defaults - larger canvas for full workspace
export const DEFAULT_LAYOUT: LayoutDimensions = { width: 1600, height: 900 }
...
export const DEFAULT_CONNECTOR_STYLES: Record<string, ConnectorStyle> = {
...
export const ANCHOR_POSITIONS: AnchorPosition[] = ['top', 'right', 'bottom', 'left', 'bottomRight', 'bottomLeft']
