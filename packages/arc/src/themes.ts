...
const defaultTheme: Theme = {
  ...
  light: {
    palette: {
      violet:  { border: 'border-violet-200/80',  bg: 'bg-violet-100/60',   icon: 'text-violet-500',  stroke: '#8b5cf6' },
      emerald: { border: 'border-emerald-200/80', bg: 'bg-emerald-100/60',  icon: 'text-emerald-500', stroke: '#10b981' },
      blue:    { border: 'border-blue-200/80',    bg: 'bg-blue-100/60',     icon: 'text-blue-500',    stroke: '#3b82f6' },
      amber:   { border: 'border-amber-200/80',   bg: 'bg-amber-100/60',    icon: 'text-amber-500',   stroke: '#f59e0b' },
      sky:     { border: 'border-sky-200/80',     bg: 'bg-sky-100/60',      icon: 'text-sky-500',     stroke: '#0ea5e9' },
      zinc:    { border: 'border-zinc-200/80',    bg: 'bg-zinc-100/60',     icon: 'text-zinc-400',    stroke: '#a1a1aa' },
      rose:    { border: 'border-rose-200/80',    bg: 'bg-rose-100/60',     icon: 'text-rose-500',    stroke: '#f43f5e' },
      orange:  { border: 'border-orange-200/80',  bg: 'bg-orange-100/60',   icon: 'text-orange-500',  stroke: '#f97316' },
    },
    background: {
      container: 'bg-white border border-zinc-200/60',
      grid: { color: 'rgba(16, 21, 24, 0.04)', opacity: 0.4, size: 28 },
    },
    text: { primary: 'text-zinc-700', secondary: 'text-zinc-500', muted: 'text-zinc-400' },
  },
  dark: {
    palette: {
      violet:  { border: 'border-violet-400/30',  bg: 'bg-violet-500/20',  icon: 'text-violet-300',  stroke: '#a78bfa' },
      emerald: { border: 'border-emerald-400/30', bg: 'bg-emerald-500/20', icon: 'text-emerald-300', stroke: '#34d399' },
      blue:    { border: 'border-blue-400/30',    bg: 'bg-blue-500/20',    icon: 'text-blue-300',    stroke: '#60a5fa' },
      amber:   { border: 'border-amber-400/30',   bg: 'bg-amber-500/20',   icon: 'text-amber-300',   stroke: '#fbbf24' },
      sky:     { border: 'border-sky-400/30',     bg: 'bg-sky-500/20',     icon: 'text-sky-300',     stroke: '#38bdf8' },
      zinc:    { border: 'border-zinc-600',        bg: 'bg-zinc-700/40',    icon: 'text-zinc-300',    stroke: '#a1a1aa' },
      rose:    { border: 'border-rose-400/30',    bg: 'bg-rose-500/20',    icon: 'text-rose-300',    stroke: '#fb7185' },
      orange:  { border: 'border-orange-400/30',  bg: 'bg-orange-500/20',  icon: 'text-orange-300',  stroke: '#fb923c' },
    },
    background: {
      container: 'bg-zinc-900 border border-zinc-700/50',
      grid: { color: '#a1a1aa', opacity: 0.04, size: 28 },
    },
    text: { primary: 'text-zinc-100', secondary: 'text-zinc-400', muted: 'text-zinc-500' },
  },
}
